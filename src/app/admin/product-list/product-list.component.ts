...
export class ProductListComponent implements OnInit{
  ...
  fetchProducts(): void {
        ...
        console.log(this.searchText);
        this.productService.getProductsList(this.currentPage, this.pageSize)
          .subscribe((res: any) => {
            console.log(res)
            this.products =res.content;
            this.totalPages = res.totalPages;
  ...
  filterProducts(){
    ...
    console.log(this.maxPrice);
     ...
     // Reset về trang 1
     this.currentPage = 0;
    this.productService.getProductListByAdvanceFilter(this.selectedInventory,this.productInput,this.selectedColors,
                                                      this.selectedBrands,this.selectedStatus,this.minPrice,this.maxPrice,
