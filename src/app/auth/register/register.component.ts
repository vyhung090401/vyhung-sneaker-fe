  ...
  onSubmit(): void {
    ...
    if (this.registerForm.valid) {
      const inf = {
        ...
        address : this.registerForm.controls['address'].value + ' ' + this.wardSelected.name + ', ' + this.districtSelected.name + ', ' + this.citySelected.name,
      }
    this.authService.register(inf.username,inf.password,inf.phone,inf.gender,inf.birthday,inf.address).subscribe({
      next: data => {
        console.log(data);
