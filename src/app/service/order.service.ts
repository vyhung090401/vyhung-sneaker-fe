...
export class OrderService {
  ...
  getOrderListByStatus(
    ...
    return this.http.get(
      `${this.baseURL}/findOrderByStatus?page=${page}&size=${size}&status=${status}`
    );
  }

  getOrderListByDateAsc(
    page: number = 0,
    size: number = 5
  ): Observable<Object> {
    return this.http.get(
      `${this.baseURL}/findByDateAsc?page=${page}&size=${size}`
    );
  }

  getOrderListByDateDesc(
    page: number = 0,
    size: number = 5
  ): Observable<Object> {
    return this.http.get(
      `${this.baseURL}/findByDateDesc?page=${page}&size=${size}`
    );
  }

  getOrderListByStatusDateAsc(
    page: number = 0,
    size: number = 5,
    status: string
  ): Observable<Object> {
    return this.http.get(
      `${this.baseURL}/findByStatusDateAsc?page=${page}&size=${size}&status=${status}`
    );
  }

  getOrderListByStatusDateDesc(
    page: number = 0,
    size: number = 5,
    status: string
  ): Observable<Object> {
    return this.http.get(
      `${this.baseURL}/findByStatusDateDesc?page=${page}&size=${size}&status=${status}`
    );
  }
  ...
  getOrderListById(
    ...
    return this.http.get(
      `${this.baseURL}/findById/${orderId}?page=${page}&size=${size}`
    );
  }

  getRevenueByMonth(month: number, year: number): Observable<Object> {
    return this.http.get(
      `${this.baseURL}/saleOfMonth?month=${month}&year=${year}`
    );
  }

  getBrandsRevenueByMonth(month: number, year: number): Observable<Object> {
    return this.http.get(
      `${this.baseURL}/brandSaleOfMonth?month=${month}&year=${year}`
    );
  }

  getProductsRevenueByMonth(
    brand: string,
    month: number,
    year: number
  ): Observable<Object> {
    return this.http.get(
      `${this.baseURL}/productSaleOfMonth?month=${month}&year=${year}&brand=${brand}`
    );
  }
  ...
  getStatisticStatusOrder(month: number, year: number): Observable<Object> {
    return this.http.get(
      `${this.baseURL}/statisticStatusOrder?month=${month}&year=${year}`
    );
  }

  get10AcountConsume(month: number, year: number): Observable<Object> {
    return this.http.get(
      `${this.baseURL}/top10AccountConsume?month=${month}&year=${year}`
    );
  }
}
